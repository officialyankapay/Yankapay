...
export const BusinessCTABanner = () => {
  return (
    <section className="w-full max-w-7xl mx-auto px-6 md:px-12 pb-12">
      <div className="flex flex-col items-start justify-between gap-6 rounded-3xl bg-[linear-gradient(168deg,rgba(23,172,158,1)_0%,rgba(10,95,88,1)_100%)] px-8 py-12 sm:flex-row sm:items-center sm:px-12">
        <div className="flex flex-col items-start gap-2">
          <h2 className="[font-family:'Space_Grotesk',Helvetica] text-[32px] font-bold leading-normal tracking-[-1px] text-white">
            Ready to scale your business?
          </h2>
          <p className="[font-family:'Manrope',Helvetica] text-base font-normal leading-normal text-white/85">
            Get started with Yanka Pay Business today.
          </p>
        </div>
        <Button
          type="button"
