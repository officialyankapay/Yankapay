...
export const StablecoinCallToAction = () => {
  return (
    <section className="w-full max-w-7xl mx-auto px-6 md:px-12 pb-12">
      <div className="flex flex-col items-start justify-between gap-6 rounded-3xl bg-[linear-gradient(168deg,rgba(23,172,158,1)_0%,rgba(10,95,88,1)_100%)] px-8 py-12 sm:flex-row sm:items-center sm:px-12" aria-labelledby="global-money-heading">
        <div className="flex flex-col items-start gap-2">
          <h2
            id="global-money-heading"
            className="[font-family:'Space_Grotesk',Helvetica] text-[32px] font-bold leading-normal tracking-[-1px] text-white"
          >
            Global money, local experience.
          </h2>
          <p className="[font-family:'Manrope',Helvetica] text-base font-normal leading-normal text-white/85">
            No wallets to configure, no seed phrases to memorize.
          </p>
        </div>
        <Button
          type="button"
